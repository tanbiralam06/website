...
function DashboardWidget({ user }) {
  ...
  return (
    <div className="flex flex-col overflow-hidden">
      ...
      <section className="py-28 relative overflow-hidden bg-[#080B19]">
        ...
        <div className="absolute inset-0">
            ...
            <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="feature-grid" width="40" height="40" patternUnits="userSpaceOnUse">
                  <path d="M0 20h40M20 0v40" stroke="rgba(99, 102, 241, 0.3)" strokeWidth="0.5" />
                </pattern>
              </defs>
          ...
          />
          <motion.div 
            className="absolute bottom-1/4 -right-20 w-96 h-96 rounded-full bg-purple-600/5 blur-3xl"
            animate={{
              scale: [1.2, 1, 1.2],
              opacity: [0.2, 0.1, 0.2],
              x: [0, -20, 0],
        ...
        <div className="container max-w-6xl mx-auto px-4 relative z-10">
          ...
          >
            <div className="inline-block px-3 py-1 rounded-full bg-indigo-900/60 backdrop-blur-sm border border-indigo-800/50 text-indigo-400 text-xs font-medium tracking-wide mb-3">
              WHY CHOOSE REACUI?
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              A powerful toolkit for modern UI development
            </h2>
            <p className="text-indigo-200/80 max-w-2xl mx-auto">
              ReacUI is designed with developer experience and user satisfaction in mind
            </p>
          </motion.div>
          
          {/* Feature diagram layout */}
          <div className="relative mx-auto flex justify-center items-center" style={{ height: "650px" }}>
            {/* SVG connector lines */}
            <svg className="absolute inset-0 w-full h-full z-0" viewBox="0 0 800 650" preserveAspectRatio="xMidYMid meet">
              {/* Center point coordinates are 400,325 */}
              ...
              <defs>
                <linearGradient id="blue-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" stopColor="#0F1835" stopOpacity="0.1" />
                  <stop offset="100%" stopColor="#3B82F6" stopOpacity="0.6" />
                </linearGradient>
                <linearGradient id="purple-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" stopColor="#1A1142" stopOpacity="0.1" />
                  <stop offset="100%" stopColor="#A855F7" stopOpacity="0.6" />
                </linearGradient>
                <linearGradient id="green-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" stopColor="#0E2A1D" stopOpacity="0.1" />
                  <stop offset="100%" stopColor="#22C55E" stopOpacity="0.6" />
                </linearGradient>
                <linearGradient id="cyan-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" stopColor="#0A2730" stopOpacity="0.1" />
                  <stop offset="100%" stopColor="#06B6D4" stopOpacity="0.6" />
                </linearGradient>
                <linearGradient id="red-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" stopColor="#291517" stopOpacity="0.1" />
                  <stop offset="100%" stopColor="#EF4444" stopOpacity="0.6" />
                </linearGradient>
                <linearGradient id="amber-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                  <stop offset="0%" stopColor="#2A2010" stopOpacity="0.1" />
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-48 h-48"
            >
              <div className="relative w-full h-full">
                ...
                <div className="absolute inset-0 rounded-full border-2 border-indigo-500 shadow-[0_0_20px_rgba(99,102,241,0.5)]"></div>
                
                {/* Inner circle */}
                <div className="absolute inset-2 rounded-full bg-[#0F1225] flex items-center justify-center text-center">
                  <div>
                    <motion.div 
                    ...
                    <div className="text-sm text-indigo-300/80 mt-1">Core Benefits</div>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              className="absolute left-[calc(50%-225px)] top-[calc(50%-125px)] z-10 transform -translate-x-1/2 -translate-y-1/2"
              initial={{ opacity: 0, scale: 0.8 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
            ...
            >
              ...
              >
                <div className="w-[90px] h-[90px] rounded-[20px] bg-[#0F1835] flex items-center justify-center shadow-[0_0_20px_rgba(59,130,246,0.15)]">
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="text-indigo-300 text-sm mt-1 max-w-[150px]">ARIA-compliant and keyboard navigable</p>
                </div>
              </motion.div>
            </motion.div>
            
            {/* Customizable - Top Center */}
            <motion.div
              className="absolute left-1/2 top-[calc(50%-225px)] z-10 transform -translate-x-1/2 -translate-y-1/2"
              initial={{ opacity: 0, scale: 0.8 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
            ...
            >
              <motion.div
                whileHover={{ y: -5, scale: 1.03 }}
                animate={{ y: [0, -6, 0] }}
                transition={{ y: { duration: 6, repeat: Infinity, repeatType: "reverse" }}}
              >
                <div className="w-[90px] h-[90px] rounded-[20px] bg-[#1A1142] flex items-center justify-center shadow-[0_0_20px_rgba(168,85,247,0.15)]">
                  <svg className="w-8 h-8 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                  </svg>
                </div>
                <div className="mt-4 text-center">
                  <h3 className="text-white font-medium text-lg">Customizable</h3>
                  <p className="text-indigo-300 text-sm mt-1 max-w-[150px] mx-auto">Easily theme and modify components</p>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              <motion.div
                whileHover={{ y: -5, scale: 1.03 }}
                animate={{ y: [0, -6, 0] }}
                transition={{ y: { duration: 5.5, repeat: Infinity, repeatType: "reverse" }}}
              >
                <div className="w-[90px] h-[90px] rounded-[20px] bg-[#0E2A1D] flex items-center justify-center shadow-[0_0_20px_rgba(34,197,94,0.15)]">
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="text-indigo-300 text-sm mt-1 max-w-[150px]">Optimized for speed and efficiency</p>
                </div>
              </motion.div>
            </motion.div>
            
            {/* Documented - Bottom Left */}
            <motion.div
              className="absolute left-[calc(50%-225px)] top-[calc(50%+125px)] z-10 transform -translate-x-1/2 -translate-y-1/2"
              initial={{ opacity: 0, scale: 0.8 }}
              whileInView={{ opacity: 1, scale: 1 }}
            ...
            >
              <motion.div
                whileHover={{ y: -5, scale: 1.03 }}
                animate={{ y: [0, -6, 0] }}
                transition={{ y: { duration: 6.5, repeat: Infinity, repeatType: "reverse" }}}
              >
                <div className="w-[90px] h-[90px] rounded-[20px] bg-[#0A2730] flex items-center justify-center shadow-[0_0_20px_rgba(6,182,212,0.15)]">
                  <svg className="w-8 h-8 text-cyan-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
                <div className="mt-4 text-center">
                  <h3 className="text-white font-medium text-lg">Documented</h3>
                  <p className="text-indigo-300 text-sm mt-1 max-w-[150px]">Comprehensive guidelines and examples</p>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              <motion.div
                whileHover={{ y: -5, scale: 1.03 }}
                animate={{ y: [0, -6, 0] }}
                transition={{ y: { duration: 7, repeat: Infinity, repeatType: "reverse" }}}
              >
                <div className="w-[90px] h-[90px] rounded-[20px] bg-[#291517] flex items-center justify-center shadow-[0_0_20px_rgba(239,68,68,0.15)]">
                  <svg className="w-8 h-8 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                  </svg>
                </div>
                <div className="mt-4 text-center">
                  <h3 className="text-white font-medium text-lg">Responsive</h3>
                  <p className="text-indigo-300 text-sm mt-1 max-w-[150px]">Works on all screen sizes</p>
                </div>
              </motion.div>
            </motion.div>
            
            {/* Composable - Bottom Center */}
            <motion.div
              className="absolute left-1/2 top-[calc(50%+225px)] z-10 transform -translate-x-1/2 -translate-y-1/2"
              initial={{ opacity: 0, scale: 0.8 }}
              whileInView={{ opacity: 1, scale: 1 }}
            ...
            >
              <motion.div
                whileHover={{ y: -5, scale: 1.03 }}
                animate={{ y: [0, -6, 0] }}
                transition={{ y: { duration: 5.2, repeat: Infinity, repeatType: "reverse" }}}
              >
                <div className="w-[90px] h-[90px] rounded-[20px] bg-[#2A2010] flex items-center justify-center shadow-[0_0_20px_rgba(245,158,11,0.15)]">
                ...
                <div className="mt-4 text-center">
                  <h3 className="text-white font-medium text-lg">Composable</h3>
                  <p className="text-indigo-300 text-sm mt-1 max-w-[150px]">Build complex UIs from simple components</p>
                </div>
              </motion.div>
            </motion.div>
            
            {/* Radial dots and glow effects */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[550px] opacity-20 pointer-events-none">
              <svg width="100%" height="100%" viewBox="0 0 550 550">
                <circle cx="275" cy="275" r="250" fill="none" stroke="rgba(99, 102, 241, 0.1)" strokeWidth="1" strokeDasharray="3,8" />
                
                {/* Small animated dots around the circle */}
                {Array.from({ length: 24 }).map((_, i) => {
                  const angle = (i * 15) * Math.PI / 180;
                  const x = 275 + 250 * Math.cos(angle);
                  const y = 275 + 250 * Math.sin(angle);
