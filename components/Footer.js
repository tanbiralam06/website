...
const Footer = () => {
  ...
  const footerSections = [
    ...
    },
    {
      title: 'Support',
      links: [
        { name: 'GitHub', href: 'https://github.com/yourusername/reacui' },
        { name: 'Issues', href: 'https://github.com/yourusername/reacui/issues' },
        { name: 'Contributing', href: 'https://github.com/yourusername/reacui/blob/main/CONTRIBUTING.md' },
      ],
    },
    {
      title: 'Legal',
      links: [
        ...
        { name: 'License', href: 'https://github.com/yourusername/reacui/blob/main/LICENSE' },
      ],
    },
  ];
  ...
  return (
    <footer className="bg-secondary-50 dark:bg-secondary-900 border-t border-secondary-200 dark:border-secondary-800">
      <div className="container py-12">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          {footerSections.map((section) => (
            <div key={section.title}>
              <h3 className="text-base font-medium text-secondary-900 dark:text-secondary-100">{section.title}</h3>
        ...
        <div className="mt-12 border-t border-secondary-200 dark:border-secondary-800 pt-8 flex flex-col md:flex-row justify-between">
